...
namespace OpenTK3_StandardTemplate_WinForms
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            planet = new Sphere3D(1, 20, 20, 1, Color.Blue);
            sun = new Sphere3D( 1, 20, 20,2,Color.Yellow);
            moon = new Sphere3D(1, 20, 20, 0.5f, Color.Gray);
        ...
        private void mainViewport_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (enableAnimation.Checked)
            {
                ...
                moon.setXYZ(planet.x + xPlaneta, planet.y + yPlaneta, planet.z);
                GL.Translate(x, y, 0);
                moon.DrawSphere();
                GL.PopMatrix();
